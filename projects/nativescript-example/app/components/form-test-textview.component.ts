...
@Component({selector: 'adf-form-test-textview', moduleId: module.id, templateUrl: './form-test-base.component.html'})
export class FormTestTextViewComponent extends FormTestBaseComponent {
  ...
  addControl(fieldsdiv: FormBuilderSubset): void {
    fieldsdiv.group.addControl({
      ...
      options: {label: TEST_CONTROL_LABEL, placeholder: TEST_CONTROL_PLACEHOLDER, cols: 20, rows: 5, wrap: true}
    });
  }
}
