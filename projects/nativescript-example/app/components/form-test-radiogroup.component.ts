...
@Component({selector: 'adf-form-test-radiogroup', moduleId: module.id, templateUrl: './form-test-base.component.html'})
export class FormTestRadioGroupComponent extends FormTestBaseComponent {
  ...
  addControl(fieldsdiv: FormBuilderSubset): void {
    fieldsdiv.group.addControl({
      ...
      options: {label: TEST_CONTROL_LABEL, valueOptions: [{value: 'mr', label: 'Mr'}, {value: 'ms', label: 'Ms'}]}
    });
  }
}
