...
const TITLE = 'Test TextField Number';
const FORM_ID = 'test-textfield-number';
const TEST_CONTROL_ID = 'test-textfield-number-control';
const TEST_CONTROL_LABEL = 'textfield-number';
const TEST_CONTROL_PLACEHOLDER = 'placeholder';

@Component(
    {selector: 'adf-form-test-textfield-number', moduleId: module.id, templateUrl: './form-test-base.component.html'})
export class FormTestTextFieldNumberComponent extends FormTestBaseComponent {
  ...
  addControl(fieldsdiv: FormBuilderSubset): void {
    fieldsdiv.group.addControl({
      ...
      options: {label: TEST_CONTROL_LABEL, placeholder: TEST_CONTROL_PLACEHOLDER, inputType: 'number'}
    });
  }
}
