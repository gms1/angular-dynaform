...
const entryComponents: any[] = [
  ...
  BasicFieldsetComponent,
  BasicButtonComponent,
  BasicCheckboxComponent,
  BasicInputComponent,
  BasicRadioGroupComponent,
  BasicSelectComponent,
  BasicSeparatorComponent,
...
export class DynamicBasicFormModule {
  constructor(
    ...
    @Optional() @SkipSelf() parentModule: DynamicBasicFormModule,
  ) {
    if (parentModule) {
      return;
    }
    ...
    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_ARRAY,
      BasicArrayComponent,
      true,
    );
    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_FIELDSET,
      BasicFieldsetComponent,
      true,
    );
    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_DIVISION,
      BasicDivisionComponent,
      true,
    );
    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_BUTTON,
      BasicButtonComponent,
      true,
    );
    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_SEPARATOR,
      BasicSeparatorComponent,
      true,
    );

    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_CHECKBOX,
      BasicCheckboxComponent,
      true,
    );
    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_INPUT,
      BasicInputComponent,
      true,
    );
    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_RADIOGROUP,
      BasicRadioGroupComponent,
      true,
    );
    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_SELECT,
      BasicSelectComponent,
      true,
    );
    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_SLIDER,
      BasicSliderComponent,
      true,
    );
    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_SWITCH,
      BasicSwitchComponent,
      true,
    );
    this.dynamicFormService.setControlComponent(
      BasicControlType.CONTROL_TEXTAREA,
      BasicTextareaComponent,
      true,
    );
  }
