...
@Component({
  selector: 'adf-nativescript-array',
  template: `
  ...
  inputs: ['model'],
  providers: [
    { provide: DynamicFormControlComponentBase, useExisting: NativeScriptArrayComponent },
  ],
})
