...
@Component({
  ...
  inputs: ['model'],
  providers: [
    { provide: DynamicFormControlComponentBase, useExisting: NativeScriptDatePickerComponent },
  ],
})
export class NativeScriptDatePickerComponent extends DynamicFormControlComponent<ValueModel> {
  model!: ValueModel;
