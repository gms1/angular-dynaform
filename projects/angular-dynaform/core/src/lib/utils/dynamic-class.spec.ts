...
class DynamicClassTestComponent implements DoCheck, OnDestroy {
  ...
  ngDoCheck(): void {
    (this.dynamicClass as DynamicClass).ngDoCheck();
  }
...
describe('dynamic CSS classes', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [DynamicClassTestComponent, DynamicClassTestContainerComponent],
    });
    fixture = TestBed.createComponent(DynamicClassTestContainerComponent);
  });
