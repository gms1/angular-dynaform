...
describe('ng-null-control', () => {
  ...
  it('value should be undefined if set to undefined (without options)', () => {
    ...
    expect(ngNullControl.value).toBeUndefined(
      'value of NgNullControl is defined after setting to undefined',
    );
  });
  ...
  it('value should be undefined if set to null (without options)', () => {
    ...
    expect(ngNullControl.value).toBeUndefined(
      'value of NgNullControl is defined after setting to null',
    );
  });
  ...
  it('value should be undefined if set to text (without options)', () => {
    ...
    expect(ngNullControl.value).toBeUndefined(
      'value of NgNullControl is defined after setting a text',
    );
  });
