...
export class DynamicFormErrorContainerComponent implements DynamicFormErrorContainer, DoCheck {
  ...
  ngDoCheck(): void {
    ...
    let sortedErrors: { key: string; payload: any }[] = Object.keys(this.model.ngControl.errors)
      .map((key) => {
  ...
  protected buildError(control: ControlModel, key: string, payload: any): DynamicValidationError {
    ...
    msg =
      msg ||
      (control.formModel.i18n &&
        control.formModel.i18n.errors &&
        control.formModel.i18n.errors[key]);
